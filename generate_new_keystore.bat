...
set "KEY_PASS=VisionCut2026SecurePass"
...
if exist "%KEYSTORE_NAME%" (
    echo [INFO] '%KEYSTORE_NAME%' already exists. Skipping creation.
) else (
    ...
    echo [SUCCESS] '%KEYSTORE_NAME%' created successfully!
)
...
echo [4/4] Copying clean Base64 string to Clipboard...
type "%CLEAN_FILE%" | clip

echo.
echo ==============================================================================
echo                   ALL 5 SECRETS FOR YOUR GITHUB REPO
echo ==============================================================================
echo.
echo 1. Secret Name:  KEYSTORE_FILE
echo    Secret Value: [COPIED TO CLIPBOARD ALREADY! Just press Ctrl+V]
echo.
...
echo    Secret Value: [Paste your Gemini / Google API Key here]
echo.
echo ==============================================================================
echo All values are saved to: %CD%\keystore_github_secret.txt
echo ==============================================================================
pause
